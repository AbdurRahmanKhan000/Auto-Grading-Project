...
1. **Clone the repository:**
   ```bash
   git clone [https://github.com/AbdurRahmanKhan000/Auto-Grading-Projeect.git](https://github.com/AbdurRahmanKhan000/Auto-Grading-Projeect.git)

1: Navigate to the project directory:

Bash
cd Auto-Grading-Projeect/oop-studio-lms/lms
